...
# img = horizShiftLeft(img, 0.05, 0.15)
# img = horizShiftRight(img, 0.05, 0.15)
# img = vertiShiftDown(img, 0.05, 0.15)
# img = vertiShiftUp(img, 0.05, 0.15)
# img = rotatedCW(img, 0.1, 0.25, 1.2)
# img = rotatedCCW(img, 0.1, 0.25, 1.2)
# img = cropSkretch(img, 0.05, 0.15)
